...
def generate_training_data(data_file,knowledge_path,test_mode=False,vocabulary_size=None,sequence_length=15):
    ...
    result=traing_data,valid_data,test_data,vocab_size,intent_num_classes,slot_num_classes
...
def load_knowledge(knowledge_path):
    ...
    for i,line in enumerate(lines):
        ...
        slot_value,slot_name=line.split(splitter) #slot_value:无痛性硬实结节;slot_name:症状关键词||症状关键词1||关联症状||关联症状2||关联症状1||主症状||症状2
